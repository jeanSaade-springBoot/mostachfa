	...
	b.extend(b.jqx._jqxGrid.prototype, {
		...
		_initmenu: function () {
			...
			if (this.host.jqxMenu) {
				...
				var A = 200;
				t = b.trim(t).replace(/\ \;/ig, "").replace(/\ \;/ig, "");
				var g = b("<span>" + t + "</span>");
		...
		_arrangemenu: function () {
			...
			var f = 200;
			e = b.trim(e).replace(/\ \;/ig, "").replace(/\ \;/ig, "");
			var g = b("<span>" + e + "</span>");
			g.addClass(this.toThemeProperty("jqx-menu-item"));
			this.host.append(g);
			f = g.outerWidth() + 60;
		...
		_rendercolumnheader: function (h, i, e, d) {
			...
			if (this.enableellipsis) {
				if (i == "left") {
					return '<div style="padding-bottom: 2px; overflow: hidden; text-overflow: ellipsis; text-align: ' + 'right' + "; margin-left: 4px; margin-right: 10px; line-height: " + e + 'px;"><span style="text-overflow: ellipsis; cursor: default;">' + h + "</span></div>"
				} else {
					return '<div style="padding-bottom: 2px; overflow: hidden; text-overflow: ellipsis; text-align: ' + 'right' + "; margin-left: 2px; margin-right: 4px; line-height: " + e + 'px;"><span style="text-overflow: ellipsis; cursor: default;">' + h + "</span></div>"
				}
			}
		...
		_renderbuttoncell: function (h, e, g, k, i) {
			if (h.host.jqxButton) {
				...
				if (j.find(".jqx-button").length == 0) {
					e.innerHTML = '<input type="button" class="'+i.split(",")[2]+'"/><i class=\"'+i.split(",")[1]+'\"></i>';
					b(e.firstChild).val(i.split(",")[0]);
